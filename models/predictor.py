...
def game_only_idd(p1_game_pct, p1_game_pct_std, p2_game_pct, p2_game_pct_std):
    ...
    # 6-6
    # hacky, unfinished on tiebreak
    set_7_6 = set_matrix[6][6] * p1_game_pct[0] / (p1_game_pct[0] + p2_game_pct[0])
    set_6_7 = set_matrix[6][6] * p2_game_pct[0] / (p1_game_pct[0] + p2_game_pct[0])
    ...
    return [p1_win_odd / total_prob, p1_win_even / total_prob, p2_win_odd / total_prob, p2_win_even / total_prob]
