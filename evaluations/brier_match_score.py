...
matches = db_conn.all_matches_year(2015,2015,'clay')
[c, right, prob] = brier(matches, 'point_iid_model')
print '2015 clay point'
print prob, c, right
print prob/c
print float(right)/c

[c, right, prob] = brier(matches, 'match_iid_model')
print '2015 clay match'
print prob, c, right
print prob/c
print float(right)/c
...
[c, right, prob] = brier(matches, 'game_iid_model')
print '2015 clay game'
print prob, c, right
print prob/c
print float(right)/c
